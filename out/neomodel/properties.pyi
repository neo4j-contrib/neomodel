...
class NormalizedProperty(Property):
    ...
    @overload
    def __get__(self, obj: None, owner: type | None = None) -> NormalizedProperty: ...
    @overload
...
class RegexProperty(NormalizedProperty):
    ...
    @overload
    def __get__(self, obj: None, owner: type | None = None) -> RegexProperty: ...
    @overload
...
class EmailProperty(RegexProperty):
    ...
    expression: str
    @overload
    def __get__(self, obj: None, owner: type | None = None) -> EmailProperty: ...
    @overload
    def __get__(self, obj: Any, owner: type | None = None) -> str: ...
    def __set__(self, obj: Any, value: str) -> None: ...
