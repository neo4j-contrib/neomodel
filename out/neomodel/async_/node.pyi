...
class AsyncStructuredNode(NodeBase):
    ...
    @classmethod
    async def create(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    @classmethod
    async def create_or_update(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    async def cypher(self, query: str, params: dict[str, Any] | None = None) -> tuple[list | None, tuple[str, ...] | None]: ...
    deleted: bool
    @hooks
    async def delete(self) -> bool: ...
    @classmethod
    async def get_or_create(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    @classmethod
