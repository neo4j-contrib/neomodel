...
class StructuredNode(NodeBase):
    ...
    @classmethod
    def create(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    @classmethod
    def create_or_update(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    def cypher(self, query: str, params: dict[str, Any] | None = None) -> tuple[list | None, tuple[str, ...] | None]: ...
    deleted: bool
    @hooks
    def delete(self) -> bool: ...
    @classmethod
    def get_or_create(cls, *props: dict[str, Any], **kwargs: dict[str, Any]) -> list: ...
    @classmethod
