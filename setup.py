...
setup(
    ...
    install_requires=['py2neo==1.5', 'pytz==2013b', 'lucene-querybuilder==0.1.6beta'],
    dependency_links=['https://github.com/scholrly/lucene-querybuilder/zipball/4b12452e#lucene-querybuilder-0.1.6beta'],
    classifiers=[
