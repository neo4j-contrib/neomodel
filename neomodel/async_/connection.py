"""
Connection management for the async neomodel module.

``AsyncConnectionManager`` owns all of the connection state (the driver and the
...
lifecycle. ``AsyncQueryRunner`` and ``AsyncSchemaManager`` operate against it,
and ``AsyncDatabase`` exposes it as a facade.
"""
...
class AsyncConnectionManager:
    ...
    def __init__(self) -> None:
        ...
        self._query: "AsyncQueryRunner | None" = None
