...
class NodeSet(BaseSet):
    ...
    def create(self, **kwargs: Any) -> StructuredNode:
        """
        ...
        node_result, _ = db.cypher_query(query, {"create_params": item})
    ...
    def get_or_create(
        ...
        **kwargs: Any,
        ...
        :rtype: tuple[StructuredNode, bool]
        """
    ...
    def bulk_create(self, *props: tuple, **kwargs: Any) -> list:
        """
        ...
        for item in [
            ...
            if relationship is None:
                ...
                query_params: dict[str, Any] = {
                    "create_params": item,
                    "source_id": db.parse_element_id(relationship.source.element_id),
                }
                labels = ":".join(self.source_class.inherited_labels())
                query = (
                    f"MATCH (source:{relationship.source.__label__}) "
                    f"WHERE {db.get_id_method()}(source) = $source_id\n"
                ...
                if lazy:
                    ...
                    query += "RETURN n"
                node_result, _ = db.cypher_query(query, query_params)
    ...
    def bulk_create_or_update(self, *props: tuple, **kwargs: Any) -> list:
        """
        ...
        query, params = self.source_class._build_merge_query(
