...
class HairDryer(StructuredNodeAsync):
    version = IntegerProperty()


class ScrewDriver(StructuredNodeAsync):
    version = IntegerProperty()


class Car(StructuredNodeAsync):
    version = IntegerProperty()


class Monkey(StructuredNodeAsync):
    name = StringProperty()
...
class ToothBrush(StructuredNodeAsync):
    name = StringProperty()
